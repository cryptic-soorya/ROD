...
# from common import STORES as ALL_STORES, SUPPLIERS as ALL_SUPPLIERS

# random.seed(101)  # separate seed from the base seeders, so this is deterministic on its own

# DB_DIR = "../mcp_server/db"
# SALES_DB     = f"{DB_DIR}/sales.db"
# INVENTORY_DB = f"{DB_DIR}/inventory.db"
# SUPPLIERS_DB = f"{DB_DIR}/suppliers.db"
# RETURNS_DB   = f"{DB_DIR}/returns.db"
# CUSTOMERS_DB = f"{DB_DIR}/customers.db"
...
#     print(f"Injected {len(log)} anomalies. Full log: seeds/anomaly_injection_log.json")
